...
parser.add_argument("--weight_neg", type=float, default=0.5, help="Default=1.0")
parser.add_argument("--weight_rec", type=float, default=0.05, help="Default=1.0")
parser.add_argument("--weight_kl", type=float, default=1.0, help="Default=1.0")
parser.add_argument("--m_plus", type=float, default=120.0, help="the margin in the adversarial part, Default=100.0")
