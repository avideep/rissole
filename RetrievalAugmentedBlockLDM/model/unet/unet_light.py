    ...
    def __init__(self,
        ...
        if self.activate_cond_layer:
            ...
            if self.use_addition:
                ...
                self.init_conv = nn.Conv2d(self.channels[0] // 2, self.channels[0], kernel_size=3, stride = 1, padding=2)
        else:
            if self.use_addition:
                pass
                # self.layer_norm = nn.LayerNorm(None)
            ...
            self.init_conv = nn.Conv2d(in_channels, self.channels[0], kernel_size=3, stride=1, padding=2)
        ...
        self.final_conv = nn.Conv2d(self.channels[0], out_channels, kernel_size = kernel_size, stride = 1, padding = padding)
