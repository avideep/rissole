...
class LSUNBedroom:
    def __init__(self, root = '/hdd/avideep/blockLDM/data/', batch_size: int = 16, dset_batch_size: int = 32, img_size = 128):
        """
        ...
        self.ROOT_PATH = root
        self.IMAGE_PATH = self.ROOT_PATH + 'lsun-bedroom/'
    ...
    def train_val_test_split(self, dataset, batch_size=16, val_ratio=0.1):
...
if __name__ == "__main__":
    data = LSUNBedroom(batch_size=16)
